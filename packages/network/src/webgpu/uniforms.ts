...
interface GeometryRegion {
  ...
  vRadius: number;
  /** Vertex level-of-detail radius floor in CSS pixels. */
  vLodPx: number;
...
export const UNIFORM_LAYOUT: readonly UniformField[] = [
  ...
  { name: 'v_lod_px', type: 'f32', word: 31, accessors: a('geometry', 'vLodPx') },
  { name: 'e_half_width', type: 'f32', word: 32, accessors: a('geometry', 'eHalfWidth') },
  { name: 'e_dash_period_px', type: 'f32', word: 33, accessors: a('geometry', 'eDashPeriodPx') },
  { name: 'height_amplitude', type: 'f32', word: 34, accessors: a('geometry', 'heightAmplitude') },
  { name: 'v_hover_id', type: 'i32', word: 35, accessors: a('focus', 'vHoverId', 'i'), init: [-1] },
  { name: 'e_hover_id', type: 'i32', word: 36, accessors: a('focus', 'eHoverId', 'i'), init: [-1] },
  {
    name: 'v_selected_id',
    type: 'i32',
    word: 37,
  ...
  { name: 'v_height_min', type: 'f32', word: 49, accessors: a('channel', 'vHeightMin') },
  { name: 'v_height_scale', type: 'f32', word: 50, accessors: a('channel', 'vHeightScale') },
  ...
  { name: 'hover_color', type: 'u32', word: 56, accessors: a('focus', 'hoverColor', 'u') },
  { name: 'selected_color', type: 'u32', word: 57, accessors: a('focus', 'selectedColor', 'u') },
  { name: 'focus_flags', type: 'u32', word: 58, accessors: a('focus', 'flags', 'u') },
  { name: 'hover_alpha', type: 'f32', word: 59, accessors: a('focus', 'hoverAlpha') },
  { name: 'selected_alpha', type: 'f32', word: 60, accessors: a('focus', 'selectedAlpha') },
  { name: 'v_hover_px', type: 'f32', word: 61, accessors: a('focus', 'vHoverPx') },
  { name: 'v_selected_px', type: 'f32', word: 62, accessors: a('focus', 'vSelectedPx') },
  { name: 'e_hover_px', type: 'f32', word: 63, accessors: a('focus', 'eHoverPx') },
  { name: 'e_selected_px', type: 'f32', word: 64, accessors: a('focus', 'eSelectedPx') },
  { name: 'v_height_out_min', type: 'f32', word: 65, accessors: a('channel', 'vHeightOutMin') },
  { name: 'v_height_out_span', type: 'f32', word: 66, accessors: a('channel', 'vHeightOutSpan') },
...
export const W_V_LOD_PX = wordOf('v_lod_px');
